...
//               type="button"
//               key={step.key}
//               className="process-step bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 relative overflow-hidden group block w-full outline-none"
...
//         {/* Detail modal */}
//         {activeIndex !== null && (
//           <StepDetail step={aiProcessSteps[activeIndex]} onClose={() => setActiveIndex(null)} />
//         )}
//       </div>
//     </section>
//   );
