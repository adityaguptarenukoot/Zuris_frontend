      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="space-y-8">
          {steps.map((step, index) => (
            <div key={index} className="work-step flex items-center gap-8 bg-white/90 backdrop-blur-sm rounded-2xl p-8 hover:shadow-lg transition-all duration-300 border border-gray-100">
        ...
        <div className="text-center mt-16">
          <p className="text-lg text-gray-700 mb-6 max-w-3xl mx-auto">
            Ready to lead your industry with AI? Let's build your intelligent future together.
          </p>
        </div>
      </div>
    </section>
