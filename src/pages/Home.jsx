...
const Home = () => {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo(heroRef.current.querySelectorAll('.hero-button'), 
      { scale: 0.9, opacity: 0 }, 
      { scale: 1, opacity: 1, duration: 0.3, ease: "power2.out", stagger: 0.1, delay: 0.4 } 
    );
      ...
      <main ref={heroRef} className="py-20 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Link
              to="/Services"
              className="hero-button border-2 border-blue-500 text-blue-600 px-10 py-4 rounded-full font-semibold text-lg hover:bg-blue-200 transition-all duration-200">
              View Our Services
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="services-grid grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="service-card bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-200 group cursor-pointer border relative overflow-hidden bg-gradient-to-br from-blue-50/70 to-purple-50/70 border-blue-200"
                ...
                <div className="absolute inset-0 border-2 border-transparent group-hover:border-blue-200 rounded-2xl transition-colors duration-200"></div>
              </div>
            ))}
          </div>
