...
const About = () => {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo(contentRef.current.querySelectorAll('.about-animate'), 
      { y: 50, opacity: 0, scale: 0.95 },
      {
        y: 0,
        opacity: 1,
  ...
  const differentiators = [
    ...
    {
      title: "End-to-End Delivery",
      description: "From strategy to implementation to ongoing support, we handle the complete journey.",
      image: "/images/packaging.png"
    },
    {
      title: "Enterprise-Grade Security",
    ...
    },
    {
      ...
      description: "We combine rapid prototyping with mature engineering practices and governance.",
      image: "/images/connection.png"
    }
  ];
  ...
  const credentials = [
    {
      ...
      description: "NIT and IIT graduates with advanced degrees in AI and computer science"
    },
    {
      icon: "🏆",
      title: "Patented Technology",
      description: "Proprietary AI solutions with patents in cutting-edge applications"
    },
    {
      icon: "🌍",
      title: "Global Experience",
      description: "50+ years of combined international experience across continents"
    },
    {
      icon: "🚀",
      title: "Proven Track Record",
      description: "Fortune 500 to startups - delivered $1B+ in business value"
    },
    {
      icon: "🎯",
      title: "AI Expertise",
      description: "Multi-dimensional AI: Vision, NLP, Multi-modal, Generative AI"
    },
    {
      icon: "👔",
      title: "Leadership Experience",
      description: "Senior leadership roles at global tech giants and innovative startups"
    }
  ];
    ...
    <div className="pt-20 min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 relative">
      ...
      <section ref={headerRef} className="py-20 text-center relative z-10">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Your trusted AI partner, turning complexity into clarity, data into insight, 
            and ideas into industry-leading innovation.
          </p>
        </div>
      </section>
      ...
      <section ref={contentRef} className="py-20 bg-white/80 backdrop-blur-sm relative z-10">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="about-animate mb-20">
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-12 border border-blue-100">
              <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">Our Mission</h2>
              <div className="max-w-5xl mx-auto">
                <p className="text-lg text-gray-700 leading-relaxed text-center mb-8">
                  In a world generating over <strong className="text-blue-600">2.5 quintillion bytes</strong> of data daily, 
                ...
                <p className="text-lg text-gray-700 leading-relaxed text-center">
                  We believe that companies who don't embrace AI will be left behind, and that data without intelligence 
                  is merely digital noise. Our role is to ensure your organization leads the AI-driven future.
                </p>
              </div>
            </div>
          ...
          <div className="about-animate mb-20">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-800 mb-4">World-Class Expertise</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Decades of experience, cutting-edge technology, and proven results
              </p>
            </div>
              ...
              {differentiators.map((item, index) => (
                <div key={index} className="group">
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 h-full relative overflow-hidden">
                    <div className="flex items-start gap-6">
                      <div className="w-16 h-16 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
                        <img 
                          src={item.image}
          ...
          {/* Key Achievements */}
          {/* <div className="about-animate">
            <div className="bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-600 rounded-3xl p-12 text-white shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                  <div className="text-center group">
                    <div className="text-5xl font-bold mb-3 drop-shadow-md group-hover:scale-110 transition-transform duration-300">
                      50+
                    </div>
                  ...
                  <div className="text-place group">
                    <div className="text-5xl font-bold mb-3 drop-shadow-md group-hover:scale-110 transition-transform duration-300">
                      Fortune 500
                    </div>
                    <div className="text-blue-100 text-lg drop-shadow-sm">
