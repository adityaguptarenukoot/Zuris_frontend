...
//         {/* CTA Section with Different Background Color */}
//         <div className="cta-section mt-20 pt-16 bg-gradient-to-br from-indigo-300 via-purple-600 to-slate-800 rounded-3xl px-8 py-12 relative overflow-hidden">
//           {/* Background Effects */}
//           <div className="absolute inset-0 opacity-10">
//             <div className="absolute top-10 left-10 w-32 h-32 bg-gradient-to-r from-blue-400 to-purple-600 rounded-full blur-3xl"></div>
//             <div className="absolute bottom-10 right-10 w-40 h-40 bg-gradient-to-r from-pink-400 to-red-600 rounded-full blur-3xl"></div>
//           </div>
